export default class Store {
  constructor(userId, mocked) {
    if (mocked) {
      this.USER_MAIN_DATA = new Promise((resolve) =>
        resolve({
          data: [
            {
              id: 12,
      ...
      this.USER_ACTIVITY = new Promise((resolve) =>
        resolve({
          data: [
            {
              userId: 12,
      ...
      this.USER_AVERAGE_SESSIONS = new Promise((resolve) =>
        resolve({
          data: [
            {
              userId: 12,
      ...
      this.USER_PERFORMANCE = new Promise((resolve) =>
        resolve({
          data: [
            {
              userId: 12,
      ...
      this.USER_MAIN_DATA = fetch(`http://localhost:3001/user/${userId}`)
        .then((res) => {
          if (res.ok) {
  ...
  getUserAverageSessions() {
    return this.USER_AVERAGE_SESSIONS;
  }
